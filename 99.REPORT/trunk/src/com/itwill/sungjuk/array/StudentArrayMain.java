package com.itwill.sungjuk.array;
...
public class StudentArrayMain {
	...
	public static void main(String[] args) {
		...
		double stuAveAll = 0;
		int[] stuRanking = new int[students.length];
		...
		for (int j = 0; j < students.length; j++) {
			...
			stuRanking[j] = ranking;
		}
		for (int i = 0; i < stuRanking.length; i++) {
			stuAveAll += (students[i].getStuAve())/students.length;
			System.out.println(students[i].getStuNo() + "\t" + students[i].getStuName() + "\t" + students[i].getStuKor() + "\t" + students[i].getStuEng() + "\t" + students[i].getStuMath() + "\t" + students[i].getStuScore() + "\t" + students[i].getStuAve() + "\t" + students[i].getStuGrade() + "\t" + stuRanking[i]);
			System.out.println("-------------------------------------------------------------");
		}
