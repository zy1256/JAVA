...
public class Account implements Comparable{
	...
	public int compareTo(Object o) {
		Account nextAccount= (Account)o;
		//return nextAccount.no.compareTo(this.no); // 내린차순
		return this.no.compareTo(nextAccount.no); //오름차순
		//return this.balance-nextAccount.balance; // 잔고
	}
